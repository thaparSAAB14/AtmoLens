  ...
  return (
    <nav className="sticky top-0 z-50 w-full backdrop-blur-[10px] bg-[var(--background)]/90 border-b border-[var(--border)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
        <div className="flex items-center justify-between gap-3 rounded-2xl bg-[var(--surface)]/80 border border-[var(--glass-border)] px-4 py-2 shadow-[0_18px_40px_-24px_rgba(0,0,0,0.35)]">
          {/* Logo */}
          <button
            onClick={() => router.push("/")}
          ...
          {/* Announcement / Status Bar (centered, hidden on small screens) */}
