...
const SkyToggle = ({ checked, onChange }: SkyToggleProps) => {
  return (
    <StyledWrapper>
...
const StyledWrapper = styled.div`
  .theme-switch {
    --toggle-size: 14px; /* [MODIFY] Scaled down from 30px */
  ...
  /* ... rest of the styles scaled accordingly ... */
  /* Note: Styled components automatically handle nesting and scoping */
