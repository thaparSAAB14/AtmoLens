                  ...
                  <Card className={cardClass}>
                    <CardContent className="p-3 h-full flex flex-col justify-between">
                      <div className="flex justify-between items-start">
                        <div className={cn("text-lg font-display font-bold transition-colors", isTodayDay ? "text-[var(--accent)]" : hasEvents ? "text-[var(--accent)]" : "text-[var(--text-muted)]")}>{format(day, "MMM d")}</div>
                        <div className={cn("text-[10px] uppercase tracking-widest transition-colors", isTodayDay ? "text-[var(--accent)]/70" : "text-[var(--text-muted)]")}>{format(day, "EEE")}</div>
                      </div>

                      {hasEvents && (
                        <div className={cn("mt-auto text-xs font-medium", isTodayDay ? "text-[var(--accent)]" : "text-[var(--text-secondary)]")}>
                    ...
                    {hasEvents && (
                      <div className="absolute bottom-0 left-0 right-0 h-1 opacity-80 bg-[var(--accent)] shadow-[0_0_10px_var(--accent)]" />
                    )}
                  </Card>
                </div>
              )
