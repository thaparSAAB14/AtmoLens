        ...
        <Reveal>
          <div className="notebook-paper p-8 sm:p-12 mb-16 dark:notebook-paper-dark depth-lifted">
            ...
            <div className="font-handwriting text-xl sm:text-2xl text-[var(--text-primary)] space-y-8 leading-[2rem]">
              ...
              <p>
                Today that idea has grown into a deterministic pipeline: the map enhancer handles archival charts,
                and Herbie powers model-guidance overlays from GDPS with explicit variable/level definitions.
              </p>
            </div>
          </div>
        </Reveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24">
          ...
          <Reveal delay={0.4}>
            <div className="bg-[#fcf8e8] dark:bg-zinc-800 p-6 rounded-sm rotate-[1.5deg] depth-floating border border-zinc-200/50 dark:border-white/5 mx-auto max-w-sm relative group curled-corner">
               ...
               <p className="font-handwriting text-lg text-zinc-800 dark:text-zinc-200 leading-relaxed">
                 We now pair that enhancer with a Herbie-backed GDPS overlay pipeline, so observations and model guidance can be viewed together.
               </p>
            </div>
          </Reveal>
        </div>
        ...
        <Reveal>
          <div className="mb-12 text-center">
            ...
            <div className="flex items-center justify-center gap-2">
               ...
               <p className="font-handwriting text-xl text-zinc-700 dark:text-zinc-300">How we do it, every 30 minutes (+ Herbie cycle refreshes).</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             {[
               ...
               { icon: Layers, title: "2. The Extraction", desc: "A deterministic mask isolates meteorological linework from the static background texture." },
               { icon: Sparkles, title: "3. The Coloration", desc: "We recolor for readability, then add optional GDPS temperature guidance generated by Herbie." },
             ].map((item, i) => (
