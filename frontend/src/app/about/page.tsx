        ...
        <Reveal>
          <div className="mb-12 text-center">
            ...
            <div className="flex items-center justify-center gap-2">
               ...
               <p className="font-handwriting text-xl text-zinc-700 dark:text-zinc-300">How we do it, completely automated every 30 minutes.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             {[
               ...
               { icon: Sparkles, title: "3. The Coloration", desc: "We recolor for readability, storing a crisp enhanced version along with the raw chart." },
             ].map((item, i) => (
